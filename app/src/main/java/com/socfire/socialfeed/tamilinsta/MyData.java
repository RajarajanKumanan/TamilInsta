...
//    static Integer[] drawableArray = {R.drawable.boy_black, R.drawable.boy_black, R.drawable.boy_black,
//            R.drawable.boy_black, R.drawable.boy_black, R.drawable.boy_black, R.drawable.boy_black,
//            R.drawable.boy_black, R.drawable.boy_black, R.drawable.boy_black, R.drawable.boy_black};
//
